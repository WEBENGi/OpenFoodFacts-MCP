 ...
 */
export function createProductAnalysisRequest(productData) {
    return {
        messages: [
            {
                role: "user",
 ...
 * @returns Sampling request configuration
 */
export function createProductComparisonRequest(product1Data, product2Data) {
    return {
        messages: [
            {
                role: "user",
 ...
 * @returns Sampling request configuration
 */
export function createGitHubRoadmapRequest(issues, repo, timeframe, focusArea) {
    return {
        messages: [
            {
                role: "user",
