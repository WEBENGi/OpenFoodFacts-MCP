 ...
 */
export function registerPrGenerator(server) {
    server.tool("generatePR", {
        ...
        try {
            ...
            const systemPrompt = "You are an expert developer helping to create a clear and comprehensive pull request. " +
