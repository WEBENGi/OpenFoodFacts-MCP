 ...
 */
export function registerTestGenerator(server) {
    server.tool("generateTests", {
        ...
        try {
            ...
            const systemPrompt = "You are an expert in test-driven development, helping to create comprehensive test cases. " +
