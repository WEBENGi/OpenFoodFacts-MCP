...
export interface ResourceDescriptor {
  ...
  description: string;
  mimeType?: string;
  developerOnly?: boolean; // Flag to mark resources only available in developer mode
}
 ...
 */
export function filterResourcesForStandardMode(resources: ResourceDescriptor[]): ResourceDescriptor[] {
 ...
 */
function isResourceAccessible(uri: string, developerMode = false): boolean {
 ...
 */
export async function routeResourceRequest(uri: string, developerMode = false) {
